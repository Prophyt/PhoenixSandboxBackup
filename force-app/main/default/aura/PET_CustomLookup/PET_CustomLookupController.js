({
    ...
    {
        var input = component.find('userinput');
    ...
    searchField : function(component, event, helper) 
    {
        ...
        var action;
        if(component.get("v.contactFilterMode", true))
        {
            action = component.get("c.getContactFilteredResults");  
        ...
        {
            action = component.get("c.getResults");
